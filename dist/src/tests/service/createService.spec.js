...
describe("Testing success cases in the route /services", () => {
    ...
    test("Should be able to create a new service", () => __awaiter(void 0, void 0, void 0, function* () {
        const service = {
    ...
    test("Should not be possible to create a new service without admin permission", () => __awaiter(void 0, void 0, void 0, function* () {
        const employee = {
            name: "Alexandre",
            cpf: "12345678911",
            password: "123456",
