...
describe("GET /employees/:id", () => {
    ...
    test("Should get one employee", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("Shouldn't find an employee with wrong id", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
