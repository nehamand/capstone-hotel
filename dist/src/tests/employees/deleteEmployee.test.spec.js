...
describe("DELETE /employees/:id", () => {
    ...
    test("Should delete an employee", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    test("Shouldn't delete an unexisting employee", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
