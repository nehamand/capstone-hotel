...
const formatGetClientData_1 = __importDefault(require("../../utils/formatGetClientData"));
const listOneClient = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const formatedClient = (0, formatGetClientData_1.default)({ client });
    return formatedClient;
});
exports.default = listOneClient;
