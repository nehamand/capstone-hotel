...
const disableBedroomService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const bedroomDisabled = yield bedroomRepository.save(bedroom);
    return {
...
exports.default = disableBedroomService;
